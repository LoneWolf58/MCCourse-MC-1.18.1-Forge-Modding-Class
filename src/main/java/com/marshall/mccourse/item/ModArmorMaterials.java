...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    COBALT("cobalt", 13, new int[]{1, 3, 5, 2}, 21, SoundEvents.ARMOR_EQUIP_GOLD,
            0.5F, 0.0F, () -> {
    ...
    private ModArmorMaterials(String pName, int pDurabilityMultiplier, int[] pSlotProtections, int pEnchantmentValue,
